    ...
    <div style={{ maxWidth: 640, margin: '0 auto', padding: '24px 16px' }}>
      <div style={{ background: '#141414', borderRadius: 16, padding: 24, marginBottom: 12 }}>
        <div style={{ display: 'flex', gap: 14, alignItems: 'center' }}>
          ...
          <div style={{ flex: 1 }}>
            <div style={{ height: 16, borderRadius: 8, width: '40%', marginBottom: 8 }} className="skeleton" />
            <div style={{ height: 12, borderRadius: 8, width: '25%' }} className="skeleton" />
          </div>
        </div>
      </div>
      {[1, 2].map(i => (
        <div key={i} style={{ background: '#141414', border: '1px solid #2A2A2A', borderRadius: 14, padding: '14px 18px', marginBottom: 10 }}>
          ...
          <div style={{ height: 12, width: 100 }} className="skeleton" />
        </div>
      ))}
    </div>
  )
    ...
    <div style={{ maxWidth: 640, margin: '0 auto', padding: '24px 16px' }}>
      ...
      {posts.length === 0 ? (
        ...
        <div key={post.id} className="animate-fade-in-up" onClick={() => router.push(`/post/${post.id}`)}
          style={{ background: '#141414', border: '1px solid #2A2A2A', borderRadius: 14, padding: '14px 18px', marginBottom: 10, cursor: 'pointer', transition: 'border-color 0.2s', animationDelay: `${Math.min(i * 0.04, 0.3)}s` }}
